window.onload = async function loadCompetitors(){
  ...
  competitors.forEach(element => {
    ...
    let row =
      ...
      "<td>" + team + "</td>" +
      "<td>" + country + "</td>" +
      "<td><button class='btn btn-outline-secondary' style='z-index: 0.5' id='update-btn' onclick=''>Update</button></td>" +
      "<td><button class='btn btn-outline-danger' style='z-index: 0.5' id='delete-btn' onclick=''>Delete</button></td>" +
      "</tr>";
